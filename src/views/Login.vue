  ...
  <div class="auth-page-premium">
    ...
    <div class="auth-card glass-panel">
      ...
      <div class="brand-header">
        ...
        <h2 class="auth-title staggered-2">Escholar System</h2>
        <p class="auth-subtitle staggered-2">Secure Administrator Portal</p>
      </div>
      ...
      <form @submit.prevent="handleLogin" class="elegant-form">
        ...
        <button type="submit" class="btn-premium btn-pulse staggered-5" :class="{ 'is-loading': loading }" :disabled="loading">
          <span v-if="!loading" class="btn-text">Authenticate <i class="bi bi-arrow-right icon-right"></i></span>
      ...
      <div v-if="error" class="error-glass mt-3 staggered-6">
        ...
        <div class="error-content">
          ...
          <p>{{ error }}</p>
          <small v-if="error.includes('Email not confirmed')" class="text-muted">
...
import { supabase, useSupabaseAuth, useSupabaseAdmins } from '../composables/useSupabase.js'
